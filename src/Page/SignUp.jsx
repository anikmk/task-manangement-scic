    ...
    <div className='flex justify-center items-center min-h-screen'>
      <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-[#fcefe7] text-gray-900'>
        <div className='mb-8 text-center'>
          <h1 className='my-3 text-[#020419] text-4xl font-bold'>Please Register Now</h1>
          <p className='text-sm text-[#a2a2a4]'>Welcome To Our Family</p>
        </div>
        <form
        ...
        <div className='flex justify-center items-center space-x-2 border m-3 p-2 border-gray-300 border-rounded cursor-pointer hover:bg-[#3b2b79ec] hover:text-white transition-all'>
          <FcGoogle size={32} />
